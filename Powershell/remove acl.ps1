Remove-NTFSAccess "d:\File Shares\AMT_Agenzia" -Account "AMTRUSTSERVICES\Milan AMT Agenzia Modify"  -AccessRights Modify -PassThru -appliesto ThisFolderSubfoldersAndFiles
Remove-NTFSAccess "d:\File Shares\AmtrustItalia" -Account "AMTRUSTSERVICES\Milan AmtrustItalia Drive Modify" -AccessRights Modify -PassThru -appliesto ThisFolderSubfoldersAndFiles
Remove-NTFSAccess "d:\File Shares\AmtrustItalia" -Account "AMTRUSTSERVICES\Milan AmtrustItalia Drive Read Only" -AccessRights ReadAndExecute -PassThru -appliesto ThisFolderSubfoldersAndFiles
...
foreach ($path in $paths) {
    ...
    Remove-NTFSAccess $path -Account "AMTRUSTSERVICES\Milan Contabilità Drive Modify" -AccessRights Modify -PassThru -appliesto ThisFolderSubfoldersAndFiles
    Remove-NTFSAccess $path -Account "AMTRUSTSERVICES\Milan Contabilità Drive Read Only" -AccessRights ReadAndExecute -PassThru -appliesto ThisFolderSubfoldersAndFiles
...
foreach ($path in $paths) {
    ...
    Remove-NTFSAccess $path -Account "AMTRUSTSERVICES\Milan Incassi e Scadenze Medmal Drive Modify" -AccessRights Modify -PassThru -appliesto ThisFolderSubfoldersAndFiles
    Remove-NTFSAccess $path -Account "AMTRUSTSERVICES\Milan Incassi e Scadenze Medmal Drive Read Only" -AccessRights ReadAndExecute -PassThru -appliesto ThisFolderSubfoldersAndFiles
...
foreach ($path in $paths) {
    ...
    Remove-NTFSAccess $path -Account "AMTRUSTSERVICES\Milan Microdata Modify" -AccessRights Modify -PassThru -appliesto ThisFolderSubfoldersAndFiles

}
 
Remove-NTFSAccess "d:\File Shares\PTF MNG\INCASSI" -Account "AMTRUSTSERVICES\Milan PTF MNG Modify" -AccessRights Modify -PassThru -appliesto ThisFolderSubfoldersAndFiles
Remove-NTFSAccess "d:\File Shares\PTF MNG\INCASSI" -Account "AMTRUSTSERVICES\Milan PTF MNG Read Only" -AccessRights ReadAndExecute -PassThru -appliesto ThisFolderSubfoldersAndFiles